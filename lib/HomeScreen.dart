...
import 'package:housie/sound_effect.dart';
      ...
      child: GestureDetector(
        onTap: (){
          ...
          _playPressed = true;
            ...
            //TODO remove after limit on ads ends
            COINS += REWARD;
            try {
              SETTINGS.saveCoins();
            }
          ...
          children: <Widget>[
            ...
            ListView(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 30.0,),
//TODO Uncomment once ads start working
//                Center(
//                  child: RaisedButton(
//                    elevation: 8.0,
//                    onPressed: (){
...
//                ),
              Center(
                child: Text('Have less than 100 coins? Don\'t worry!\nPressing play will automatically add 250 coins!', textAlign: TextAlign.center,),
              ),
              ],
            ),
